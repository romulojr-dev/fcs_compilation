...
\usepackage{amsmath, amssymb, amsfonts, mathtools, bm, mathrsfs, esvect}

\usepackage{graphicx, xcolor, tikz, pgfplots}
\usepackage[siunitx, american]{circuitikz} % For Electrical Network problems

\tikzset{
        Karrow/.style={-Stealth, red, line width=1pt},
        Darrow/.style={-Stealth, blue, dashed, line width=1pt},
        Tarrow/.style={-Stealth, black, line width=1.25pt}
}
...
\begin{tikzpicture}[scale=1.0, every node/.style={font=\large}]
    % J1
    \node[circle, draw, minimum size=3cm] (J1) at (0,0) {$J_1$};
    \draw[Tarrow] (50:1.4cm) arc[start angle=50, end angle=10, radius=1.4cm] node[midway, right] {$T(t)$};
    \draw[Karrow] (120:1.25cm) arc[start angle=120, end angle=160, radius=1.25cm] node[midway, left] {$K_1\,\theta_1$};
    \draw[Darrow] (245:1.25cm) arc[start angle=245, end angle=205, radius=1.25cm] node[midway, below left] {$D_1\,\dot{\theta}_1$};
    \draw[Karrow] (340:1.25cm) arc[start angle=340, end angle=300, radius=1.25cm] node[midway, right] {$(K_2)(\theta_1-\theta_2)$};
    \draw[Darrow] (300:1.45cm) arc[start angle=300, end angle=260, radius=1.45cm] node[midway, below right] {$(D_2)(\dot{\theta}_1-\dot{\theta}_2)$};

    % J2
    \begin{scope}[shift={(4,0)}]
        \node[circle, draw, minimum size=3cm] (J2) at (0,0) {$J_2$};
        \draw[Karrow] (120:1.25cm) arc[start angle=120, end angle=160, radius=1.25cm] node[midway, left] {$(K_2)(\theta_2-\theta_1)$};
        \draw[Darrow] (245:1.25cm) arc[start angle=245, end angle=205, radius=1.25cm] node[midway, below left] {$(D_2)(\dot{\theta}_2-\dot{\theta}_1)$};
        \draw[Karrow] (340:1.25cm) arc[start angle=340, end angle=300, radius=1.25cm] node[midway, right] {$(K_3)(\theta_2-\theta_3)$};
        \draw[Darrow] (300:1.45cm) arc[start angle=300, end angle=260, radius=1.45cm] node[midway, below right] {$(D_3)(\dot{\theta}_2-\dot{\theta}_3)$};
        \node at (0,1.9) {$\theta_2$};
    \end{scope}

    % J3
    \begin{scope}[shift={(8,0)}]
        \node[circle, draw, minimum size=3cm] (J3) at (0,0) {$J_3$};
        \draw[Karrow] (120:1.25cm) arc[start angle=120, end angle=160, radius=1.25cm] node[midway, left] {$(K_3)(\theta_3-\theta_2)$};
        \draw[Darrow] (245:1.25cm) arc[start angle=245, end angle=205, radius=1.25cm] node[midway, below left] {$(D_3)(\dot{\theta}_3-\dot{\theta}_2)$};
        \draw[Karrow] (340:1.25cm) arc[start angle=340, end angle=300, radius=1.25cm] node[midway, right] {$K_4\,\theta_3$};
        \draw[Darrow] (300:1.45cm) arc[start angle=300, end angle=260, radius=1.45cm] node[midway, below right] {$D_4\,\dot{\theta}_3$};
        \node at (0,1.9) {$\theta_3$};
    \end{scope}
\end{tikzpicture}
\end{figure}
...
\noindent\textbf{Matrix Representation}
...
\noindent\textbf{Solving for $\Theta_3(s)$}
...
\begin{tikzpicture}[scale=1.0, every node/.style={font=\large}]
    ...
    \draw[Tarrow] (50:1.4cm) arc[start angle=50, end angle=10, radius=1.4cm] node[midway, right] {$T(t)$};
    \draw[Darrow] (245:1.25cm) arc[start angle=245, end angle=205, radius=1.25cm] node[midway, below left] {$D_1\,\dot{\theta}_1$};
    \node at (1.1,-0.3) {$(D_2..D_5)$};

    % J2
    \begin{scope}[shift={(4,0)}]
        \node[circle, draw, minimum size=3cm] (J2) at (0,0) {$J_2$};
        \node at (0,1.9) {$\theta_2$};
        \node at (-1.3,-0.3) {$(D_2..D_5)$};
        \node at (1.3,-0.3) {$(D_6..D_9)$};
    \end{scope}
    ...
    \begin{scope}[shift={(8,0)}]
        \node[circle, draw, minimum size=3cm] (J3) at (0,0) {$J_3$};
        \node at (0,1.9) {$\theta_3$};
        \node at (-1.1,-0.3) {$(D_6..D_9)$};
        \node at (1.0,-0.3) {$D_{10}$};
    \end{scope}
\end{tikzpicture}
\end{figure}
...
\begin{tikzpicture}[scale=1.0, every node/.style={font=\large}]
    ...
    \draw[Tarrow] (50:1.4cm) arc[start angle=50, end angle=10, radius=1.4cm] node[midway, right] {$T(t)$};
    \draw[Karrow] (120:1.25cm) arc[start angle=120, end angle=160, radius=1.25cm] node[midway, left] {$K_1\,\theta_1$};
    \draw[Karrow] (340:1.25cm) arc[start angle=340, end angle=300, radius=1.25cm] node[midway, right] {$(K_2..K_5)(\theta_1-\theta_2)$};

    % J2
    \begin{scope}[shift={(4,0)}]
        \node[circle, draw, minimum size=3cm] (J2) at (0,0) {$J_2$};
        \node at (0,1.9) {$\theta_2$};
        \node at (-1.3,-0.3) {$(K_2..K_5)$};
        \node at (1.3,-0.3) {$(K_6..K_9)$};
    \end{scope}
    ...
    \begin{scope}[shift={(8,0)}]
        \node[circle, draw, minimum size=3cm] (J3) at (0,0) {$J_3$};
        \node at (0,1.9) {$\theta_3$};
        \node at (-1.1,-0.3) {$(K_6..K_9)$};
        \node at (1.0,-0.3) {$K_{10}$};
    \end{scope}
\end{tikzpicture}
\end{figure}
